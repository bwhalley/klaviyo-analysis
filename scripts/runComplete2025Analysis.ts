/**
 * Run Complete 2025 Analysis
 * 
 * This script processes all fetched events and runs the complete analysis
 */

import { analyzeSubscriptionToOrder } from '../src/runSubscriptionToOrderAnalysis'

// 2025 subscription events (all 9 events from API)
 ...
 * 
 * @param orderEvents - All order events from Klaviyo API (138 events total)
 */
export async function runComplete2025Analysis(orderEvents: any[]) {
